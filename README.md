...
### Demo
[Click here](https://atlas.mindmup.com/torobotaki/bibmup_example/index.html) to check out the interactive mindmap example on [MindMup Atlas](http://atlas.mindmup.com). Use "F" on your keyboard to collapse/uncollapse nodes and, "A" to see the attachments.
